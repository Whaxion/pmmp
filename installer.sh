...
BRANCH="api3/network"
NAME="PocketMine-MP"
BUILD_URL="https://poggit.pmmp.io/r/3774/PocketMine-MP.phar"
...
if ! [ -s "$NAME.phar" ] || [ "$(head -n 1 $NAME.phar)" == '<!DOCTYPE html>' ]; then
	...
	if [ "$CHANNEL" == "soft" ]; then
		download_file "https://raw.githubusercontent.com/pmmp/PocketMine-Soft/${BRANCH}/resources/start.sh" > start.sh
	else
